...
# 2 "<built-in>" 2
# 1 "SpiCommunication.c" 2
# 1 "./SpiCommunication.h" 1
# 53 "./SpiCommunication.h"
...
_Bool txDone(Spi * this);
_Bool rxDone(Spi * this);
static _Bool healthy(Spi * this);
...
static void reset(Spi * this) {
    this->hwInterrupEnable(0);
    this->hwreset();
    this->state.val = 0x0F;
    this->writeByte_2(0);
    this->charsToReceive = 0;
    this->charsToSend = 0;
    this->hwInterrupEnable(1);
}
